...
- [x] Nominally empty wells on LC279 have reads; why?
  - Issue disappeared after getting correct LC279 sample sheet.
- [x] LC398 might be out of alignment, so interpret with care.
- [x] Discuss high mito% on LC249 and LC258 with Zoe. We'd like to retain these cells unless there's a strong reason not to.
  - Zoe says she doesn't know of any good reason for this result. Therefore, we will try to retain as many of these cells as possible and perhaps exclude chrM from HVGs?
