...
We could also consider reducing the minimum number of cells per sample, although we are already using a rather low minimum.
...
<aside>
A PDF version of Figure \@ref(fig:degs-ignoring-clusters-heatmap) is available in [`output/DEGs/degs-ignoring-clusters-heatmap.pdf`](../output/DEGs/degs-ignoring-clusters-heatmap.pdf).
</aside>
