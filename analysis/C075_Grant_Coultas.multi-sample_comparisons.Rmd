...
gzout <- gzfile(
  description = file.path(outdir, "ignoring_clusters.directional.GO.csv.gz"),
  open = "wb")
write.csv(
  go,
  gzout,
...
gzout <- gzfile(
  description = file.path(outdir, "ignoring_clusters.directional.KEGG.csv.gz"),
  open = "wb")
write.csv(
  kegg,
  gzout,
...
```{r barcode-plot, fig.cap = "Barcode plot of the gene set supplied by Zoe. An enrichment line shows the relative enrichment of the vertical bars in each part of the plot is displayed.", fig.asp = 1 / 3}
par(mfrow = c(2, 3))
